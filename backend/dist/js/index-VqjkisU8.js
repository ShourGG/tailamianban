import X from"./index-BolWzKi2.js";import{r as M,e as Y,c as E,n as j,k as J,aM as Q,Q as z,R as d,S as t,U as s,j as n,V as i,K as r,F as I,N as V,_ as p,$ as b,Y as q,l as k,I as D}from"./vue-vendor-Bom1XEVO.js";import{aA as L,aO as Z,X as ee,U as se,L as te,J as ie,K as ne,S as oe,af as re,as as ae,P as le,W as ue,a1 as de,a0 as me,Y as ce}from"./ui-vendor-lRdd6BJd.js";import{_ as pe}from"./_plugin-vue_export-helper-DlAUqK2U.js";import"./index-DdVua9dR.js";import"./spline-vendor-Cs6wJgUK.js";import"./charts-vendor-CvHUaZlk.js";import"./editor-vendor-D83MfH0r.js";const _e={1:{"user:view":!0,"user:edit":!0,"user:delete":!1,"system:admin":!1},2:{"user:view":!0,"user:edit":!0,"user:delete":!0,"system:admin":!1},3:{"user:*":!0,"system:*":!0},4:{"user:view":!0,"user:edit":!1,"user:delete":!1,"system:admin":!1},5:{}};function fe(){const _=M(1),o=Y([{id:1,name:"普通编辑员",desc:"可查看和编辑用户"},{id:2,name:"管理员",desc:"用户管理权限"},{id:3,name:"超级管理员",desc:"所有权限（通配符）"},{id:4,name:"只读用户",desc:"只能查看"},{id:5,name:"无权限用户",desc:"无任何权限"}]),m=E(()=>o.find(O=>O.id===_.value)||o[0]),N=E(()=>_e[_.value]||{});return{activeTab:M("basic"),currentUserId:_,currentUser:m,currentPermissions:N,userProfiles:o,operationCount:M(0)}}function ve(_){const o=L(),m=(a,l)=>{if(l[a])return!0;for(const c of Object.keys(l))if(c.endsWith("*")&&a.startsWith(c.slice(0,-1)))return l[c];return!1},N=(a,l,c)=>{const S=_.currentPermissions.value;m(a,S)?(_.operationCount.value++,o.success(`执行操作: ${l}`)):o.warning(`权限不足，无法执行"${l}"操作`)},O=(a,l,c="OR",S)=>{const B=_.currentPermissions.value,u=a.filter(f=>m(f,B));if(c==="AND"?u.length===a.length:u.length>0)_.operationCount.value++,o.success(`执行操作: ${l}`);else{const f=c==="AND"?"且":"或";o.warning(`权限不足，需要"${a.join(`"${f}"`)}权限才能执行"${l}"操作`)}};return{switchUser:async a=>{_.currentUserId.value=a,await j();const l=_.userProfiles.find(c=>c.id===a);o.info(`用户已切换: ${l?.name}`)},performSecureOperation:(a,l)=>{N(a,l)},performMultiSecureOperation:(a,l,c="OR")=>{O(a,l,c)},resetDemo:()=>{_.operationCount.value=0,o.info("演示状态已重置")}}}const T={basic:`<!-- 基础用法 -->
